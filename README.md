...
* [x] **Startup Refactor:** Remove `environment.robot` in favour of reworking `manage-app.py` and `task.py` and introducing `commonhooks.resource` to support launching of browsers for tests.
